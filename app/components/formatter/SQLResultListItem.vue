...
<template>
  <ResultItem>
    <template #header>
      <div class="mt-4 flex justify-between px-4" style="height: 32px">
        ...
        <div>
          <Button
            severity="danger"
            class="mr-1 h-full p-0"
            icon="pi pi-trash"
            size="small"
            @click="onClickDeleteResult"
            style="width: 32px"
          />
          <Button class="mr-1 h-full p-0" icon="pi pi-copy" size="small" @click="onClickCopy" style="width: 32px" />
        </div>
      </div>
    </template>
    <template #conetent>
